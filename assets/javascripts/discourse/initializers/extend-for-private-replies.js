  ...
  initialize(container) {
    ...
    withPluginApi("0.8.28", api => {
      ...
      api.onPageChange(() => {
        ...
        const topicReplyButtons = document.querySelectorAll('.topic-footer-main-buttons .btn-primary.create');
        ...
        const topicReplyButton = document.querySelectorAll('.btn.btn-icon-text.post-action-menu__reply.reply.create.fade-out.btn-flat');
        topicReplyButton.forEach(button => {
            button.style.display = 'none';
        });
      });
    });
